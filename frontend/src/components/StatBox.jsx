...
export default function StatBox({ label, value, hint, status, badge }) {
  ...
  return (
    <li className="relative flex min-h-[8rem] flex-col rounded-xl border border-hair bg-surface p-4 pb-5">
      ...
      {meta && <span aria-hidden className="absolute inset-x-0 bottom-0 h-1 rounded-b-xl" style={{ background: meta.color }} />}
    </li>
  );
}
